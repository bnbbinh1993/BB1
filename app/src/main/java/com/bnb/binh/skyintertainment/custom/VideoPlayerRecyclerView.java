package com.bnb.binh.skyintertainment.custom;
...
import com.bnb.binh.skyintertainment.util.VideoPlayerViewHolder;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if(!isEndOfList){
            ...
            // nếu có nhiều hơn 2 mục danh sách trên màn hình, hãy đặt chênh lệch là 1
            if (endPosition - startPosition > 1) {
                endPosition = startPosition + 1;
            }

            // có gì đó không phải. trở về.
            if (startPosition < 0 || endPosition < 0) {
                return;
            }

            // nếu có nhiều hơn 1 mục danh sách trên màn hình
        ...
        // video đã phát nên quay lại
        if (targetPosition == playPosition) {
            return;
        }

        // đặt vị trí của mục danh sách sẽ được phát
        playPosition = targetPosition;
        if (videoSurfaceView == null) {
            return;
        }

        // xóa mọi lượt xem bề mặt cũ khỏi các video đang phát trước đó
    ...
    /**
     * Trả về vùng hiển thị của bề mặt video trên màn hình.
     * nếu một số bị cắt, nó sẽ trả về ít hơn @videoSurfaceDefaultHeight
     * @param playPosition
     * @return
     */
